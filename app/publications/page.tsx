  ...
  return (
    <div className="space-y-12">
        ...
        <div className="space-y-6">
          ...
          <div className="card border-l-4 border-blue-600">
            ...
            <p className="text-gray-700 mb-4">
              ...
              providing insights for therapeutic interventions and community mental health programs.
            </p>
            <a 
          ...
          <div className="card border-l-4 border-blue-600">
            ...
            <p className="text-gray-700 mb-4">
              ...
              offering evidence-based recommendations for parents, educators, and mental health professionals.
            </p>
            <a 
      ...
      <section className="bg-blue-600 text-white rounded-lg p-8">
        <h2 className="text-3xl font-bold mb-6">Didee Publications</h2>
        <p className="text-xl mb-6 opacity-90">
          Daniel is the founder of Didee Publications, a platform dedicated to advancing psychological research 
          and making academic knowledge accessible to practitioners and researchers worldwide.
        </p>
        <a 
